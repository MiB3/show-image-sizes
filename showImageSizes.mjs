...
//     window.addEventListener('resize', useDebounceFn(showImagesSizes, 100))
//     window.addEventListener('scroll', useDebounceFn(showImagesSizes, 100))
